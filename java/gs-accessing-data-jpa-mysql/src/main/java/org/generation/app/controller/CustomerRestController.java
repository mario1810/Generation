...
import org.generation.app.dto.PagoJs;
...
public class CustomerRestController {
	...
	@GetMapping("/customerCompra/{id}") //localhost:puerto/api/customers
	public PagoJs customerPago(@PathVariable Long id){
		Customer cliente=customerService.findCustomerById(id);		
		PagoJs pago= new PagoJs();
		
		pago.setCostoTotal(3000);
		pago.
		pago.setIdUsuario(cliente.getIdCustomer());
		return pago;		
	}
